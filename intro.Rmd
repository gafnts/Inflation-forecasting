...
Dado a que naturalmente existe un periodo de tiempo entre el ajuste de las condiciones monetarias y el efecto que este cambio podría originar en las variables reales del sistema macroeconómico, la autoridad monetaria---bajo un régimen de metas explícitas de inflación---actúa en el presente considerando sus pronósticos sobre el comportamiento de los precios en el futuro.
