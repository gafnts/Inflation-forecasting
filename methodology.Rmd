...
table_one <- 
  ...
  "banana", "Tasa de variación interanual del valor promedio (dólares por tonelada) de las exportaciones de banano", "SECMCA",
...
$^1$ Nivel de significancia entre paréntesis.
