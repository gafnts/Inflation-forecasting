...
```{r}
sarima_3 <- sarima(last = "2021-09-02", horizon = 3)
...
```{r}
sarima_9 <- sarima(last = "2021-03-02", horizon = 9)
...
```{r}
sarima_12 <- sarima(last = "2020-12-02", horizon = 12)
...
```{r}
sarima_24 <- sarima(last = "2019-12-02", horizon = 24)
